...
const searchAvailableUsers = catchAsync(async (req, res) => {
...
const createOrGetAOneOnOneChat = catchAsync(async (req, res) => {
...
const createAGroupChat = catchAsync(async (req, res) => {
...
const deleteOneOnOneChat = catchAsync(async (req, res) => {
  const { chatId } = req.params;
...
const addNewParticipantInGroupChat = catchAsync(async (req, res) => {
...
const removeParticipantFromGroupChat = catchAsync(async (req, res) => {
  const { chatId, participantId } = req.params;
